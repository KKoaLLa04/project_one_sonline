             ...
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                -->
                 ...
                 <!-- 
                    test - begin 
                -->
                 <li class="nav-item has-treeview <?php echo (activeMenuSidebar('test') || activeMenuSidebar('exam')) ? 'menu-open' : false ?>">
                     <a href="#" class="nav-link <?php echo (activeMenuSidebar('test') || activeMenuSidebar('exam')) ? 'active' : false ?>">
                         <i class="nav-icon fa fa-scroll"></i>
                         <p>
                             Quản lý thi online
                             <i class="fas fa-angle-left right"></i>
                ...
                -->
                 ...
                 <!-- 
                    document - begin 
                -->
                 <li class="nav-item has-treeview <?php echo (activeMenuSidebar('document') || activeMenuSidebar('exam')) ? 'menu-open' : false ?>">
                     <a href="#" class="nav-link <?php echo (activeMenuSidebar('document') || activeMenuSidebar('exam')) ? 'active' : false ?>">
